          ...
          <RevealSection>
            <section className="hero-section">
              <div className="hero-copy">
                ...
                <div className="hero-actions"><button className="button button--primary" onClick={() => navigate('contact', 'kontakt')}>Kontakt aufnehmen</button><button className="text-link" onClick={() => document.getElementById('leistungen')?.scrollIntoView({ behavior: 'smooth' })}>Unsere Leistungen <ChevronRight size={17} /></button></div>
              </div>
